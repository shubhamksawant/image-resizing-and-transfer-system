...
# Define the S3 buckets and SNS topic using lambda environment variables 
bucket_2 = os.environ['DESTINATION_BUCKET']
bucket_1 = os.environ['SOURCE_BUCKET']
...
def resize_and_compress_image(image_data, quality=30):
